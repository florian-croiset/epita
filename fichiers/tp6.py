...
structure = {
    "C_island/Fundamentals/Errors": [
        "basic_mistake.c", "fancy_mistake.c", "fix_errors.c",
        "hello_world.c", "infinite.c", "sum.c", "sum.h", "variables.c"
    ],
    "C_island/Fundamentals/Makefile": [
        "Makefile", "multi.c", "multi.h", "square.c", "square.h"
    ],
    "C_island/Proficiencies/Tools": [
        "Makefile", "infinite_gdb.c", "losers_mistake.c"
    ]
}
...
if __name__ == "__main__":
    print("=== Script de création de structure EPITA (Prog 102) ===")
    ...
    folder_name = f"epita-prepa-computer-science-prog-102-p-01-2030-{prenom}.{nom}"
